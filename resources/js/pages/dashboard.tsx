    ...
    return (
        ...
        >
            ...
            <div className="p-4 sm:p-6 lg:p-8 space-y-8 max-w-7xl mx-auto w-full">
                ...
                <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-blue-600/10 via-indigo-600/10 to-purple-600/10 dark:from-blue-950/40 dark:via-indigo-950/40 dark:to-purple-950/40 border border-blue-500/20 p-6 sm:p-8 backdrop-blur-md">
                        ...
                        <div>
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-xs text-neutral-500 dark:text-neutral-400">
                                    ID: <code className="font-mono text-neutral-700 dark:text-neutral-300 font-semibold">{merchant.merchant_code}</code>
                                </span>
                            </div>
                            ...
                            <p className="text-sm text-neutral-600 dark:text-neutral-400 mt-1 max-w-2xl">
                                Full mock payment engine for Midtrans Core API and Snap. Test checkout, Virtual Accounts (BCA/BNI/BRI/Mandiri), QRIS, and asynchronous webhook delivery seamlessly.
                            </p>
                        </div>
                    ...
                    <div className="mt-6 pt-6 border-t border-neutral-200 dark:border-neutral-800/80 grid grid-cols-1 md:grid-cols-2 gap-3 text-xs">
                        <div className="flex items-center justify-between p-2.5 rounded-xl bg-white/70 dark:bg-neutral-900/70 border border-neutral-200 dark:border-neutral-800 backdrop-blur-sm">
                            <div className="flex items-center gap-2 overflow-hidden">
                                <span className="font-semibold text-neutral-500 dark:text-neutral-400 uppercase">Server Key:</span>
                                <code className="font-mono text-neutral-800 dark:text-neutral-200 truncate">{apiKey.server_key}</code>
                            </div>
                            <button
                                onClick={() => copyToClipboard(apiKey.server_key, 'Server Key')}
                            ...
                            >
                                {copiedKey === 'Server Key' ? <Check className="size-3.5 text-emerald-500" /> : <Copy className="size-3.5" />}
                            </button>
                        </div>

                        <div className="flex items-center justify-between p-2.5 rounded-xl bg-white/70 dark:bg-neutral-900/70 border border-neutral-200 dark:border-neutral-800 backdrop-blur-sm">
                            <div className="flex items-center gap-2 overflow-hidden">
                                <span className="font-semibold text-neutral-500 dark:text-neutral-400 uppercase">Client Key:</span>
                                <code className="font-mono text-neutral-800 dark:text-neutral-200 truncate">{apiKey.client_key}</code>
                            </div>
                            <button
                                onClick={() => copyToClipboard(apiKey.client_key, 'Client Key')}
                                className="p-1.5 rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-800 text-neutral-500 hover:text-neutral-900 dark:hover:text-white transition-colors cursor-pointer"
                                title="Copy Client Key"
                            >
                                {copiedKey === 'Client Key' ? <Check className="size-3.5 text-emerald-500" /> : <Copy className="size-3.5" />}
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="p-5 rounded-2xl bg-white dark:bg-neutral-900/90 border border-neutral-200 dark:border-neutral-800 shadow-sm space-y-3">
                        ...
                        <div>
                            ...
                            <div className="text-xs text-neutral-500 dark:text-neutral-400 mt-1 flex items-center gap-2">
                                <span className="text-emerald-500 font-semibold">{stats.settlement_count} paid</span>
                                <span>•</span>
                                <span className="text-amber-500 font-semibold">{stats.pending_count} pending</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-2 bg-white dark:bg-neutral-900/90 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-5 sm:p-6 shadow-sm space-y-4">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-xs text-neutral-500 dark:text-neutral-400">
                                    Daftar transaksi charge & snap simulator terbaru
                                </p>
                            </div>
                            <Link
                        ...
                        {recentTransactions.length === 0 ? (
                            <div className="p-8 text-center text-neutral-500 dark:text-neutral-400 text-xs">
                                Belum ada transaksi yang dibuat. Buat transaksi pertama via Sandbox Tester atau Midtrans API.
                            </div>
                        ) : (
                                            ...
                                            <tr key={tx.id} className="hover:bg-neutral-50 dark:hover:bg-neutral-800/40 transition-colors">
                                                ...
                                                <td className="py-3 px-3 text-right font-sans">
                                                    {tx.snap_token && tx.transaction_status === 'pending' ? (
                                                        ...
                                                        >
                                                            Buka Snap <ExternalLink className="size-3" />
                                                        </a>
                                                    ) : (
                                                        <Link
                                                            href="/dashboard/transactions"
                        ...
                        {recentWebhooks.length === 0 ? (
                            ...
                            <div className="space-y-3">
                                {recentWebhooks.map((log) => (
                                    ...
                                    >
                                        <div className="flex items-center justify-between">
                                            <span className="font-mono font-semibold text-neutral-900 dark:text-neutral-200 truncate max-w-[140px]">
                                                {log.order_id}
                                            </span>
                                            <span
                                            ...
                                            >
                                                {log.http_status ? `HTTP ${log.http_status}` : 'FAILED'}
                                            </span>
                                        </div>
